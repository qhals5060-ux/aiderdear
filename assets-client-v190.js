export function createAssetsClient({getFirebase=()=>window.AiderDearFirebase,fetchImpl=(...args)=>fetch(...args),events=window}={}){
 ...
 return Object.freeze({identity,read,save,history:(id,cursor)=>call('history',{id,cursor}),generation:()=>epoch});
}
