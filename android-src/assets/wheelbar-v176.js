...
(() => {
  'use strict';
  const names=Object.freeze({fifth:'MY 공간',personal:'펄스널',routine:'루틴',event:'이벤트',todo:'투두 · 메모'});
  const shapes=Object.freeze({
    ...
    todo:'<path d="m3 6 1.6 1.6L7 4.6M10 6h10M3 13l1.6 1.6L7 11.6M10 13h10M10 20h10"/><rect x="3" y="18" width="3.5" height="3.5" rx=".6"/>'
  });
