...
$taskTestSources169=@('WidgetProvider.java','WidgetNativeV164.java','WidgetDesignV165.java','WidgetApprovedV188.java','WidgetRowsV164.java','WidgetNavV164.java','WidgetSizeV169.java','WidgetCompactCalendarV181.java','WidgetPreviewFrameV181.java','WidgetNativeContractTest.java') | ForEach-Object { Join-Path $PSScriptRoot $_ }
