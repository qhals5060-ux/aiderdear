...
$taskSources176=@('WidgetProvider.java','WidgetNativeV164.java','WidgetDesignV165.java','WidgetApprovedV188.java','WidgetThemeV190.java','WidgetRowsV164.java','WidgetNavV164.java','WidgetSizeV169.java','WidgetCompactCalendarV181.java','WidgetPreviewFrameV181.java') | ForEach-Object {Join-Path $PSScriptRoot $_}
...
foreach($taskFile176 in Get-ChildItem -LiteralPath $taskPackage176 -File -Filter '*.smali'){
    if($taskFile176.Name -notmatch '^Widget(Provider|NativeV164|DesignV165|ApprovedV188|ThemeV190|RowsV164|NavV164|SizeV169|CompactCalendarV181|PreviewFrameV181)(\$|\.)'){throw 'Unexpected helper class'}
