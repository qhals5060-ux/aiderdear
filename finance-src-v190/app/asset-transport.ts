...
export const assetRequest=(body?:unknown)=>request(value=>body?value.save(body):value.read());
export const assetHistoryRequest=(id:string,cursor?:number)=>request(value=>value.history(id,cursor));
